  ...
  for (let i = 0; i < 20; i++) {
    ...
    signals.push({
      ...
      title: [
        ...
        "Analisis Keamanan Siber: Ancaman Malware Phishing yang Menyamar Jadi Aplikasi Mobile Banking",
        "Transformasi Digital Perbankan: Efisiensi Kantor Cabang dan Migrasi ke SuperApp",
        "Debat Biaya Layanan Tarik Tunai dan Cek Saldo di Jaringan ATM Bersama",
        "Isu Spekulasi Rencana Merger Dua Bank Syariah Swasta Nasional",
      ][i % 10],
      content: [
        "Sejumlah nasabah mengeluhkan transfer antarbank via BI-FAST mengalami pending dan saldo terpotong namun dana belum sampai ke rekening tujuan sejak pagi hari.",
        "Beberapa utas viral di media sosial mempermasalahkan transaksi mencurigakan kartu kredit luar negeri tanpa verifikasi OTP, mendesak investigasi forensik sistem keamanan.",
        "Nasabah mengapresiasi kecepatan respon chatbot AI perbankan yang mampu menyelesaikan kendala blokir kartu debit dan cek mutasi dalam hitungan detik.",
        "Pengamat teknologi mendiskusikan klausul pembagian data nasabah untuk integrasi credit scoring fintech, mengingatkan kepatuhan terhadap UU Pelindungan Data Pribadi (UU PDP).",
        "Kampanye pembiayaan hunian dengan suku bunga berjenjang menarik ribuan pendaftaran nasabah milenial dan gen Z dalam 3 hari pertama expo properti.",
        "Keluarga korban penipuan modus link undangan pernikahan mengeluhkan lambatnya proses blokir rekening penampung oleh pihak call center perbankan.",
        "Kanal review teknologi membongkar modus trojan Android yang menduplikasi antarmuka perbankan populer untuk mencuri kredensial m-token nasabah.",
        "Wawancara direksi mengenai efisiensi operasional dan pertumbuhan volume transaksi digital sebesar 45% YoY berkat fitur lifestyle di aplikasi mobile.",
        "Warganet memperdebatkan penyesuaian tarif administrasi ATM antarbank, sebagian memahami biaya pemeliharaan mesin sementara sebagian merasa terbebani.",
        "Rumor aksi korporasi dan konsolidasi aset bank syariah memicu fluktuasi pergerakan saham serta perdebatan mengenai potensi rasionalisasi karyawan.",
      ][i % 10],
    ...
    prompts: [
      {
        ...
        engine: "ChatGPT",
        brand: "Narriv",
        competitor: "Bank Central Asia (BCA)",
        brandTone: "positive",
        compTone: "neutral",
      },
      {
