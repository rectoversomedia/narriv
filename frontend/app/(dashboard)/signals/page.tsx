...
function SourceDonut() {
  return (
    <Panel className="p-4">
      <div className="flex items-start justify-between gap-3"><div><h3 className="text-[15px] font-black text-[#101334]">Sumber Signal</h3><p className="mt-1 text-[11px] font-bold text-[#68739F]">Distribusi berdasarkan sumber data.</p></div><button type="button" className="inline-flex h-8 items-center gap-2 rounded-[8px] border border-[#DDE3EF] px-3 text-[10px] font-black text-[#31406B]">24 Jam Terakhir <ChevronDown size={12} /></button></div>
